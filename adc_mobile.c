...
void ADCMobileInit()
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_2;//определяем порты 1
	...
	//ADC_SoftwareStartInjectedConvCmd(ADC1, ENABLE);//Запуск преобразований в бесконечном режиме, так как настроена непрерываная работа
